...
//                                market.setBarcode(value.toString());
...
//                                String key = "price";
//                                itemMap.put(key, value);
//                                double priceD=  new Double(value.toString());
//
//                                stock.setPrice(priceD);
//                                //addDescription.setLocation(value.toString());
//
//                            }
//
...
//                                itemMap.put(key, value);
//                                double updatePrice=  new Double(value.toString());
//
//                                stock.setUpdatePrice(updatePrice);
//                                //addDescription.setLocation(value.toString());
//
//                            }
...
//                    assetModel.setFound(false);
                    ...
                    StockDatabase.getMarketDatabase(context.getApplicationContext()).marketDao().insertMarketList(stock);
